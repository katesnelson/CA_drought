...
#repeat for each year 2006-2015
######################################
...
writeOGR(cv_huc_dup,".","wrbyhuc.2015", driver="ESRI Shapefile") #write the water right by huc shapefile
...
names(full.wrbyhuc) = c("huc12_id.06", "AreaAcres.06",  "AreaSqKm.06",   "HUC12_id",      "Name.06",    "diverse.06",    "wr_cnt.06",     "rip_cnt.06",    "pre_cnt.06",   
...
# also aggregate(count function) pixels with positive farmland flag by hucs to get approximate area of farmland per huc
